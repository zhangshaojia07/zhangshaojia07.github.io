...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem 0.5rem;">
  ...
  <div style="flex: 1 0 22rem">
    <label>Place of Birth</label>
    <a href="https://maps.app.goo.gl/G6p9U3zakjPKdMEL7">
    <input type="text" value="Hangzhou, Zhejiang Province, China" readonly style="display: block; width: 100%; height: 38px; box-sizing: border-box;">
    </a>
  </div>
